...
public class Span implements org.apache.thrift.TBase<kamon.zipkin.thrift.Span, kamon.zipkin.thrift.Span._Fields>, java.io.Serializable, Cloneable, Comparable<kamon.zipkin.thrift.Span> {
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(kamon.zipkin.thrift.Span.class, metaDataMap);
  }
   ...
   */
  public Span(kamon.zipkin.thrift.Span other) {
  ...
  public kamon.zipkin.thrift.Span deepCopy() {
    return new kamon.zipkin.thrift.Span(this);
  }
  ...
  public kamon.zipkin.thrift.Span set_trace_id(long trace_id) {
    this.trace_id = trace_id;
    set_trace_id_isSet(true);
    return this;
  }
  ...
  public kamon.zipkin.thrift.Span set_name(String name) {
    this.name = name;
    return this;
  }
  ...
  public kamon.zipkin.thrift.Span set_id(long id) {
    this.id = id;
    set_id_isSet(true);
    return this;
  }
  ...
  public kamon.zipkin.thrift.Span set_parent_id(long parent_id) {
  ...
  public kamon.zipkin.thrift.Span set_annotations(List<Annotation> annotations) {
    this.annotations = annotations;
    return this;
  }
  ...
  public kamon.zipkin.thrift.Span set_binary_annotations(List<BinaryAnnotation> binary_annotations) {
    this.binary_annotations = binary_annotations;
    return this;
  }
  ...
  public kamon.zipkin.thrift.Span set_debug(boolean debug) {
    this.debug = debug;
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof kamon.zipkin.thrift.Span)
      return this.equals((kamon.zipkin.thrift.Span)that);
    return false;
  }

  public boolean equals(kamon.zipkin.thrift.Span that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(kamon.zipkin.thrift.Span other) {
  ...
  private static class SpanStandardScheme extends StandardScheme<kamon.zipkin.thrift.Span> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, kamon.zipkin.thrift.Span struct) throws TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, kamon.zipkin.thrift.Span struct) throws TException {
      struct.validate();
  ...
  private static class SpanTupleScheme extends TupleScheme<kamon.zipkin.thrift.Span> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, kamon.zipkin.thrift.Span struct) throws TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, kamon.zipkin.thrift.Span struct) throws TException {
