...
public class BinaryAnnotation implements org.apache.thrift.TBase<kamon.zipkin.thrift.BinaryAnnotation, kamon.zipkin.thrift.BinaryAnnotation._Fields>, java.io.Serializable, Cloneable, Comparable<kamon.zipkin.thrift.BinaryAnnotation> {
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(kamon.zipkin.thrift.BinaryAnnotation.class, metaDataMap);
  }
   ...
   */
  public BinaryAnnotation(kamon.zipkin.thrift.BinaryAnnotation other) {
    if (other.is_set_key()) {
      this.key = other.key;
    }
  ...
  public kamon.zipkin.thrift.BinaryAnnotation deepCopy() {
    return new kamon.zipkin.thrift.BinaryAnnotation(this);
  }
  ...
  public kamon.zipkin.thrift.BinaryAnnotation set_key(String key) {
    this.key = key;
    return this;
  }
  ...
  public kamon.zipkin.thrift.BinaryAnnotation set_value(byte[] value) {
    this.value = value == null ? (ByteBuffer)null : ByteBuffer.wrap(Arrays.copyOf(value, value.length));
    return this;
  }

  public kamon.zipkin.thrift.BinaryAnnotation set_value(ByteBuffer value) {
    this.value = org.apache.thrift.TBaseHelper.copyBinary(value);
    return this;
  }
   ...
   * @see AnnotationType
   */
  public kamon.zipkin.thrift.BinaryAnnotation set_annotation_type(AnnotationType annotation_type) {
    this.annotation_type = annotation_type;
    return this;
  }
  ...
  public kamon.zipkin.thrift.BinaryAnnotation set_host(Endpoint host) {
    this.host = host;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof kamon.zipkin.thrift.BinaryAnnotation)
      return this.equals((kamon.zipkin.thrift.BinaryAnnotation)that);
    return false;
  }

  public boolean equals(kamon.zipkin.thrift.BinaryAnnotation that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(kamon.zipkin.thrift.BinaryAnnotation other) {
  ...
  private static class BinaryAnnotationStandardScheme extends StandardScheme<kamon.zipkin.thrift.BinaryAnnotation> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, kamon.zipkin.thrift.BinaryAnnotation struct) throws TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, kamon.zipkin.thrift.BinaryAnnotation struct) throws TException {
      struct.validate();
  ...
  private static class BinaryAnnotationTupleScheme extends TupleScheme<kamon.zipkin.thrift.BinaryAnnotation> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, kamon.zipkin.thrift.BinaryAnnotation struct) throws TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, kamon.zipkin.thrift.BinaryAnnotation struct) throws TException {
