...
trait ZipkinWebFactory { self: App =>
  ...
  val webRootUrl = flag("zipkin.web.rootUrl", "http://localdocker:8585/", "Url where the service is located")
  ...
  val queryDest = flag("zipkin.web.query.dest", "query:9411", "Location of the query server")
